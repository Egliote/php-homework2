...
class OpenWMapP implements iWeatherProvider
{
    private $apiKey;
    ...
    private function fetchCurrentTemperature(Location $location):float
    {
        ...
        if (null === $json) {
            throw new WPException('Can\'t get JSON from OpenWeatherMap');
        }
    ...
    public function getTemperatureValue($json): float
    {
        ...
        if (isset($json->main->temp)) {
            ...
            throw new WPException('Can\'t get temperature from openweathermap');
        }
        return $temperature;
    }
}